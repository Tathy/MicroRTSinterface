...
public class SmartRR_DSLxDSLForReport implements Callable<Float> {
    ...
    public SmartRR_DSLxDSLForReport(String sIA1, String idIA, boolean side, String map) {
        this.sIA1 = sIA1;        
        this.idIA = idIA;
    ...
    public Float call() throws Exception {        
        ...
        AI ai2 = new botEmptyBase(utt, idIA, "bo2");
        if(changeSide){
            AI aiT = ai1;
            ai1 = ai2;
            ai2 = aiT;
