...
public class SettingsAlphaDSL {
    ...
    private static final float CURRENT_TEMPERATURE = 1.0f;
    ...
    private static final int ITERATIONS_SA_BEST_RESPONDE = 5;
    //private static final String MAP = "maps/basesWorkers8x8A.xml";
    private static final String MAP = "maps/NoWhereToRun9x8.xml";
    //private static final String MAP = "maps/RangedHeavyMixed.xml";
   ...
   private static final boolean APPLY_RULES_REMOVE = false;
