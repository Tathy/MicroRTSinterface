...
//                        new RangedRush(utt),
//                        new LightRush(utt),
            new botEmptyBase(utt, "train(Worker,20,Up) harvest(5) attack(Worker,closest)", "Inicial"), //            new botEmptyBase(utt, "harvest(4) build(Barrack,2,Down) train(Worker,100,EnemyDir) "
